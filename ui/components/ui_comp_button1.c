...
lv_obj_t * ui_Button1_create(lv_obj_t * comp_parent)
{
    ...
    lv_obj_set_width(cui_Button1, 65);
    lv_obj_set_height(cui_Button1, 54);
    lv_obj_set_x(cui_Button1, -466);
    lv_obj_set_y(cui_Button1, -254);
    ...
    lv_obj_set_style_bg_img_src(cui_Button1, &ui_img_1716423352, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_border_width(cui_Button1, 1, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_color(cui_Button1, lv_color_hex(0x000000), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_opa(cui_Button1, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(cui_Button1, lv_color_hex(0x2100FF), LV_PART_MAIN | LV_STATE_CHECKED);
    lv_obj_set_style_bg_opa(cui_Button1, 255, LV_PART_MAIN | LV_STATE_CHECKED);
    lv_obj_set_style_bg_img_src(cui_Button1, &ui_img_1716423352, LV_PART_MAIN | LV_STATE_CHECKED);
